Quick web app that I made for a presentation. The aim of the web app is to generate shuffled gestures for the students to use while playing a gesture game.
